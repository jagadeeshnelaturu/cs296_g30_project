...
%\begin{center}\includegraphics[height=5cm,width=20cm]{Debug_crop_prof.png}\end{center}
...
\section{Analyzing The Callee-Caller Graph}
	...
	\begin{figure}\begin{center}\includegraphics[height=5cm,width=20cm]{output_debug_crop.png}\caption{Callee-Caller Graph For Debug Mode}\end{center}\end{figure}
	\begin{figure}[h]\begin{center}\includegraphics[height=5cm,width=20cm]{output_release_crop.png}\caption{Callee-Caller Graph For Release Mode}\end{center}\end{figure}
