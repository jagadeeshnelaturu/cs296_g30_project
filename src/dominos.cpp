  ...
  dominos_t::dominos_t()
  {
	...
	{  // main block
		 ...
		 // shape.SetAsBox(15.0f, 7.5f); // rectangle of 16x10 units
		  ...
		  b2Body* body = m_world->CreateBody(&main_bd);
		  body->CreateFixture(&main_fd);
		 ...
		 //left arm
		  ...
		  b2Body* leftarm_b = m_world->CreateBody(&leftarm_bd);
		  ...
		  claw_s.SetAsBox(2.0f, 0.5f);
		  b2BodyDef claw_bd;
		  claw_bd.position.Set(-29.0f, 16.5f);
		  claw_bd.type = b2_dynamicBody;
		  b2Body* claw_b = m_world->CreateBody(&claw_bd);
		  ...
		  b2BodyDef claw1_bd;
		  claw1_bd.position.Set(-29.5f, 18.0f);
		  ...
		  jointDef5.localAnchorA.Set(1.5f,0);
