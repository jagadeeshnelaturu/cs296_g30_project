...
void create_glui_ui(void)
{
  ...
  glui->add_statictext("Move Left Arm Up: w"); 
  glui->add_statictext("Move Left Arm Down: s");
  glui->add_statictext("Move Left Claw Up: o");   
  glui->add_statictext("Move Left Claw Down: l");
  
  new GLUI_Column( glui, false );
  glui->add_statictext("Right Arm Controls"); 
  glui->add_statictext("Move Right Arm Up: e"); 
